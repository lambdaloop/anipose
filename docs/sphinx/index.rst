...
Anipose is an open-source toolkit for robust, markerless 3D tracking of animal behavior from multiple camera views. It leverages the machine learning toolbox 
 `DeepLabCut <https://github.com/AlexEMG/DeepLabCut>`_
to track keypoints in 2D, then triangulates across camera views to estimate 3D pose.
